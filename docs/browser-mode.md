...
- `--browser-bundle-format <text|zip>`: choose the bundle format. `text` keeps the existing single Markdown-style text bundle; `zip` preserves individual file names in one uploaded archive.
